import { Image, StyleSheet, Text, View, ScrollView, Touchable, SafeAreaView } from 'react-native'
  ...
  return (
    ...
    <View style={styles.container}>
        ...
        <View style={styles.text2}>
          <Text style={styles.text2Style}>By continuing the process, you're to Freya's</Text>
