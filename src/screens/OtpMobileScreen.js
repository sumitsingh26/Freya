...
const OtpMobileScreen = () => {
  ...
  const goToAnotherScreen = () => {
    if (validate()) {
      ...
      console.log(data);
      let endPoint = 'api/auth/otp/phone';
      otpMobile(data, endPoint).then(response => {
        ...
        if (response.Success == true) {
          ...
          navigation.replace('Dashboard'); // Navigate to the 'Login' screen
        } else {
          cloaseLoaderModel();
          Toast.show({
            type: 'error',
      ...
      <SafeAreaView>
        <KeyboardAwareScrollView>
          <View style={styles.rootContainer}>
            <Image source={imagepath.otpImage}></Image>
            <Text style={styles.txt1}>{t('Text Sent')}</Text>
            <Text style={styles.txt2}>
              {t(
                'A Text with verification code has been sent to your provided number. Write the code below to continue.',
              )}
            </Text>
            ...
            <View style={styles.containerTextRow2}>
              <Text style={styles.text1}>{t(`didn't_receive_it_yet`)}</Text>
            ...
            <View style={styles.buttonViewStyle}>
              <TouchableOpacity onPress={goToAnotherScreen}>
                <Text style={styles.buttonTxtStyle}>{t('Continue')}</Text>
              </TouchableOpacity>
            </View>
            <Modal
              animationType="fade"
...
export default OtpMobileScreen;
