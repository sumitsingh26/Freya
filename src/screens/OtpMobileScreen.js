  ...
  return (
    <ImageBackground style={{ width: "100%", height: "100%" }} resizeMode={"cover"} source={imagepath.loginBgImage}>
      ...
      <View style={styles.rootContainer}>
        ...
        <Text style={styles.txt1}>Text Sent!</Text>
        <Text style={styles.txt2}>A Text with verification code has been sent to your provided number. Write the code below to continue.</Text>
