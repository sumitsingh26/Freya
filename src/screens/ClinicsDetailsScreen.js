import { StyleSheet, Text, View, Image, TextInput,FlatList, TouchableOpacity, SafeAreaView } from 'react-native'
    ...
    <View style={styles.rootContainer}>
      ...
      <View style={styles.searchContainer}>
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center',}}>
          <Image style={{ width: 17, height: 17 }} source={imagepath.searchIcon} />
          <TextInput placeholder='Search' placeholderTextColor={"white"} style={styles.searchTextContainer} />
        </View>
      </View>
      {/* <ScrollView style={{marginTop: 10}}> */}
      <View style={styles.titleContainer}>
        <Text style={styles.titleTextContainer}>Whats new near you ✨</Text>
